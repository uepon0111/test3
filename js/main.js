...
function _setupAutoSave() {
  EventBus.on('playback:update', () => {
    ...
    Storage.setSetting('volume_normalize_mode', AppState.volumeNormalizeMode);
  });
}
...
async function initApp() {
  ...
  try {
    ...
    AppState.volumeNormalizeMode = await Storage.getSetting('volume_normalize_mode', false);
